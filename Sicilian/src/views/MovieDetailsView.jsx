...
export const MovieDetailsView = () => {
  ...
  const getSwedishAgeText = rated => {
    const age = ratingToAge(rated);
    if (age === 0) return 'Ingen åldersgräns';
    if (age === 100) return 'Okänd åldersgräns';
    return `Från ${age} år`;
  };
    ...
    <div className='movie-details-container'>
      ...
      <div className='movie-info-section'>
        ...
        <div className='movie-metadata-grid'>
          ...
          <div className='metadata-block'>
            <h3>Åldersgräns</h3>
            <p>{getSwedishAgeText(movie.movie_rated)}</p>
          </div>
          <div className='metadata-block'>
            <h3>Speltid</h3>
